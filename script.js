const options = [
    {id:"option1", text:"Suga", votes:0},
    {id:"option2", text:"Jungkook", votes:0},
    {id:"option3", text:"Jimin", votes:0},
    {id:"option4", text:"RM", votes:0},
    {id:"option5", text:"V", votes:0},
    {id:"option6", text:"J-hope", votes:0},
    {id:"option7", text:"jin", votes:0},
];
